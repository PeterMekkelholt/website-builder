...
function About() {
  return (
    <div>
      {/*<Header />*/}
      <Container sx={{ my: 3 }} component="main" >
        <CssBaseline />
        <Typography
        ...
        <Typography sx={{ px: 0, pb: 12 }}>
          ...
          and Momentus (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), concerning your access
          to and use of the momentus.ai website, including any reports or
          insights provided by the site based on the data that you provide
          through the Site (or through other means) (&quot;Data&quot;), as well as any
          ...
          &quot;Site&quot;). We are registered in California, United States and have our
          registered office at 900 Veterans Blvd, 6th Floor, Redwood City,
          94063. You agree that by accessing the Site, you have read,
          ...
          understand the terms that Terms apply. You will be subject to and will
          ...
          Site. The account will not be charged and the subscription will be
          suspended until upgraded to a paid version at the end of the free
          trial.
          <br />
          <br />
          The Site features functionality designed to provide insights based on
          certain data that is submitted by users and is provided &quot;as-is&quot;
          without any warranties as to the accuracy of the insights or the
          output of the Site and Users should not rely on the accuracy thereof.
          The functionality of the Site is in &quot;testing&quot; or &quot;pilot&quot; mode – and by
          accepting the Terms and submitting your data through the Site, you
          hereby agree (1) that the data on the operations of your fleet (the
          &quot;Data&quot;) you provide may be used to improve or modify the functionality
          of the Site or future intellectual property that We may develop, (2)
          that by participating in the &quot;pilot&quot; you are not acquiring any
          intellectual property rights in the Site or the underling
          functionality thereof or any intellectual property that is developed
          in the future based on the Site or the Data, (3) that you will provide
          feedback on the output of the Site as may be reasonably requested by
          Us.
          <Typography
            sx={{ pt: { xs: 0, md: 6 }, pb: 4 }}
            variant="h4"
          ...
          interferes with any partyâ€™s uninterrupted use and enjoyment of the
          ...
          interchange formats (â€œgifsâ€), 1Ã—1 pixels, web bugs, cookies, or
          other similar devices (sometimes referred to as â€œspywareâ€ or
          â€œpassive collection mechanismsâ€ or â€œpcmsâ€).
          <br />
          ...
          <br />
          17. Copy or adapt the Siteâ€™s software, including but not limited to
          ...
          is in lieu of, and supersedes, any other FAR, DFARS, or other clause
          ...
          appropriate, the AAAâ€™s Supplementary Procedures for Consumer Related
          ...
          and, where appropriate, limited by the AAA Consumer Rules. If
          ...
          place in CALIFORNIA, California. Except as otherwise provided herein,
          ...
          and federal courts located in CALIFORNIA, California, and the Parties
          ...
          ACCURACY OR COMPLETENESS OF THE SITEâ€™S CONTENT OR THE CONTENT OF ANY
          ...
          claim, or demand, including reasonable attorneysâ€™ fees and expenses,
